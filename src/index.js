...
//     fetch(`https://pixabay.com/api/?key=32422911-2885b1c6f49cc11c5847f0c8c&q=${searchQuery}&image_type=photo&orientation= horizontal&safesearch=true&page=1&per_page=40`)
//     .then(r => r.json())
//     .then(console.log)
// };

// const BASE_URL = 'https://pixabay.com/api/';
// fetch(`https://pixabay.com/api/?key=32422911-2885b1c6f49cc11c5847f0c8c&q=cat&image_type=photo&orientation= horizontal&safesearch=true&page=1&per_page=40`)
//     .then(r => r.json())
//     .then(console.log)
